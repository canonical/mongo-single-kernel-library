...
If you used the Database Integrator charm to integrate your application with Charmed MongoDB, remove all the integration
specified in {ref}`remove-the-integration`.
