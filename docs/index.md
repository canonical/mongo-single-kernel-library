---
relatedlinks: "[Charmhub&#32;|&#32;MongoDB&#32;VM](https://charmhub.io/mongodb?channel=8/edge), [Charmhub&#32;|&#32;MongoDB&#32;K8s](https://charmhub.io/mongodb-k8s?channel=8/edge)"
myst:
  html_meta:
...
* **Advanced configuration**: {ref}`Manage persistent storage <manage-persistent-storage>` • {ref}`Enable LDAP <enable-ldap>`
...
* **Security**: {ref}`TLS encryption <tls>` • {ref}`Hardening guide <hardening-guide>`
