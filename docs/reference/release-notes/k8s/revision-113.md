...
Charmed MongoDB K8s Revision 113 has been deployed to the [`6/stable` channel](https://charmhub.io/mongodb-k8s?channel=6/stable) on Charmhub.
...
This charm is based on the Canonical [charmed mongodb rock](https://ghcr.io/canonical/charmed-mongodb@sha256:e94bbb288671e405f33a0494b23a643977bd284df997be95e57d1e6cb6856fa9). It packages:
