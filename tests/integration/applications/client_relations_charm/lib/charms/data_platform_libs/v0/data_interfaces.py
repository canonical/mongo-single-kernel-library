...
class RequirerData(Data):
    ...
    @property
    def secret_fields(self) -> list[str] | None:
    ...
    @juju_secrets_only
    def _get_relation_secret(
        self, relation_id: int, group: SecretGroup, relation_name: str | None = None
    ) -> CachedSecret | None:
        """Retrieve a Juju Secret that's been stored in the relation databag."""
        if not relation_name:
            relation_name = self.relation_name
    ...
    def _fetch_specific_relation_data(
        self, relation, fields: list[str] | None = None
    ) -> dict[str, str]:
    ...
    def _fetch_my_specific_relation_data(self, relation, fields: list[str] | None) -> dict:
        """Fetching our own relation data."""
